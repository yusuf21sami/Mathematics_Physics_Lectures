...
A Zener diode is a special type of diode designed to reliably allow current to flow "backwards" (inverted polarity) when a certain threshold of reverse voltage, known as the [Zener voltage](https://www.falstad.com/circuit/e-zeneriv.html), is reached.
